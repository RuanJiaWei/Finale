		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-center cl-effect-15">
					...
					<li><a href="<%=basePath%>login/setup.jsp" data-hover="注册">注册</a>
					</li>
				</ul>
		...
		<div class="banner-info">
			...
			<div class="container">
				...
				<div class="banner-text">
					<h1>
						<a href="index.jsp">We are</a> <br> <a href="index.jsp">
							HITer</a>
					</h1>
				</div>
							...
							<div id="myTabContent" class="tab-content">
								<div role="tabpanel" class="tab-pane fade in active" id="home"
									...
									<div class="tabcontent-grids">
										<p>国际化是世界一流大学建设的必由之路，我们把国际化建设作为推动学校发展的重要抓手，
											以国际化推动学校各项改革，努力营造吸引、汇聚国际顶尖科学家和优秀海外学生的良好环境。
											坚持“深交”与“广交”相结合的原则，遵循量变到质变的客观发展规律， 坚持“学校为主导、院系为主体、
											师生为核心、项目为支撑”的国际化建设指导思想，按照自下而上、自上而下相结合的方式推进国际化进程。</p>
										<ul>
								...
								<div role="tabpanel" class="tab-pane fade" id="carl"
									...
									<div class="tabcontent-grids">
										<p>按照“选拔一流的学生、派往国外一流的学校、师从世界上一流的导师”的要求，学校通过联合培养、交换学生、
											...
											举办世界文化节、美国周、俄罗斯宣传日、模拟联合国等活动，积极营造良好的校园国际化氛围。</p>
									</div>
								</div>
								<div role="tabpanel" class="tab-pane fade" id="carl"
									aria-labelledby="carl-tab">
									<div class="tabcontent-grids">
										<p>学校设立了国际合作与交流基金，用于资助举办国际会议、聘请高水平海外专家
											、参加各种国际学术活动等。出台了“引进海外留学人员回国工作”、“聘请海外教授兼任哈工大博士生导师”、
											“聘请外国合约专家”、“首席国际学术顾问计划”等一系列政策，加大人才引进力度。一系列得力的措施使得学校国际化的道路越走越宽，
											逐步形成“国际会议有声音，国际组织有地位，国际杂志有文章，国际合作有伙伴”的良好局面。</p>
									</div>
								</div>
								<div role="tabpanel" class="tab-pane fade" id="carl"
									aria-labelledby="carl-tab">
									<div class="tabcontent-grids">
										<p> 我校来华留学生工作在《国家中长期教育改革和发展规划纲要》、
										...
										来华留学工作可持续发展提升工程。努力实现“让不知道哈工大的外国学生了解哈工大，让了解哈工大的外国学生留学哈工大，热爱哈工大，学在哈工大”。</p>
									</div>
								</div>
								<div class="clearfix"></div>
							</div>
